...
export default class Matches extends Component {
    ...
    showPlayed=(played)=>{
        const list=this.state.matches.filter(match=>{return match.final===played
        });
        this.setState({
    ...
    showResult=(result)=>{
        const list=this.state.matches.filter(match=>{return match.result===result
        });
        this.setState({
